<?php
//Este módulo recupera muetra el listado de porducto de la categoria HOGAR

	//Consulta Recuperar productos de la categoria Informatica
	$query_rsVwProductos = "SELECT * FROM vwProductos WHERE categoria = 'Hogar' ";
...
<div id="Hogar" class="spacer10em"></div>
